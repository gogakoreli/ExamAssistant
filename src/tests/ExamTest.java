...
public class ExamTest {
	...
	public void testSetsAndGetsOne() {	
		...
		exam.setStartTime(new Date(120));
		...
		assertEquals(exam.getStartTime(), new Date(120));
		assertEquals(exam.getStartDateTime(), new Date(120));
		assertEquals(exam.getStatus(), ExamStatus.NEW);
	}
	
	@Test
	public void testSetsAndGetsTwo() {	
		exam = new Exam(2, "c", "MidTerm", new Date(10), 120, "Open", 2, ExamStatus.FINISHED);
		...
		assertEquals(exam.getStartDateTime(), new Date(10));
		assertEquals(exam.getStatus(), ExamStatus.FINISHED);
	}
	
	@Test
	public void testSetsAndGetsThree() {	
		exam = new Exam(3, "c1", "MidTerm", new Date(10), 90, "Open", 2, ExamStatus.LIVE);
